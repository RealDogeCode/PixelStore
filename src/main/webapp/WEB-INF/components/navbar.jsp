...
<nav class="hnav">
	...
	%>
	<ul>
		<li class="nav-logo"><a href="${pageContext.request.contextPath}/Homepage"><img src="images/logo.png" width="50" height="50"></img></a></li>
		...
		<li><a href="${pageContext.request.contextPath}/Publisher/Dashboard">Admin Dashboard</a></li>
		<% } %>
		
		<% if(user != null && user.getRoles().contains(Role.ADMIN)) { %>
		<li><a href="${pageContext.request.contextPath}/Admin/Dashboard">Publisher Dashboard</a></li>
		<% } %>
		
		<li class="nav-center nav-search"><input type="text" placeholder="Esplora il catalogo..."></li>
		<li class="nav-cart"><a href="${pageContext.request.contextPath}/Cart"><img src="images/cart.png"  width="50" height="50"></a></li>
